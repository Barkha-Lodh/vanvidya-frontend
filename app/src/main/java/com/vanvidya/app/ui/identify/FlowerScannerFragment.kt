...
class FlowerScannerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_flower_scanner, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        identifyButton.setOnClickListener { identifyFlower() }
    ...
    // ✅ FULLY REPLACED — now uses Django backend (Gemini)
    private fun identifyFlower() {
        ...
        lifecycleScope.launch {
            try {
                ...
                if (response.isSuccessful && response.body() != null) {
                    ...
                    // Build JSON and open PlantDetailsActivity
                    ...
                    resultText.text = "Could not identify flower. Try a clearer photo."
